      ...
      >
        <div className="container mx-auto px-6 md:px-12 flex items-center justify-between">
          ...
          <Link to="/" className="relative z-50 group">
            <span
              className={`text-2xl md:text-3xl font-[Playfair_Display] font-bold tracking-tight transition-colors duration-300 ${
          ...
          {/* Icons - Minimal & Sharp */}
          <div
            className={`hidden lg:flex items-center space-x-8 transition-colors duration-300 relative ${
              isDarkInfo ? "text-black" : "text-white"
            }`}
          >
                ...
                {isUserMenuOpen && user && (
                  ...
                  >
                    <div className="border-b border-gray-100 pb-4 mb-4">
                      ...
                      <p className="text-[10px] uppercase bg-gray-100 inline-block px-2 py-1 mt-2 rounded">
                        {user.role}
                      </p>
                    </div>
                    <button
          ...
          >
            <div className="flex flex-col items-center space-y-8">
              ...
              <motion.div
                ...
                className="grid grid-cols-2 gap-12 mt-8 text-black"
              >
                <button
                  onClick={handleUserClick}
